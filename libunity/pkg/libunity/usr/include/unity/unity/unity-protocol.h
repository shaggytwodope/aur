/* unity-protocol.h generated by valac 0.28.0, the Vala compiler, do not modify */
...
UnityProtocolAnnotatedIcon* unity_protocol_annotated_icon_construct (GType object_type, GIcon* base_icon);
void unity_protocol_annotated_icon_add_hint (UnityProtocolAnnotatedIcon* self, const gchar* name, GVariant* value);
GVariant* unity_protocol_annotated_icon_get_hint (UnityProtocolAnnotatedIcon* self, const gchar* name);
void unity_protocol_annotated_icon_set_colorize_rgba (UnityProtocolAnnotatedIcon* self, gdouble r, gdouble g, gdouble b, gdouble a);
GIcon* unity_protocol_annotated_icon_get_icon (UnityProtocolAnnotatedIcon* self);
void unity_protocol_annotated_icon_set_icon (UnityProtocolAnnotatedIcon* self, GIcon* value);
const gchar* unity_protocol_annotated_icon_get_ribbon (UnityProtocolAnnotatedIcon* self);
void unity_protocol_annotated_icon_set_ribbon (UnityProtocolAnnotatedIcon* self, const gchar* value);
UnityProtocolCategoryType unity_protocol_annotated_icon_get_category (UnityProtocolAnnotatedIcon* self);
void unity_protocol_annotated_icon_set_category (UnityProtocolAnnotatedIcon* self, UnityProtocolCategoryType value);
gboolean unity_protocol_annotated_icon_get_use_small_icon (UnityProtocolAnnotatedIcon* self);
void unity_protocol_annotated_icon_set_use_small_icon (UnityProtocolAnnotatedIcon* self, gboolean value);
guint32 unity_protocol_annotated_icon_get_colorize_value (UnityProtocolAnnotatedIcon* self);
void unity_protocol_annotated_icon_set_colorize_value (UnityProtocolAnnotatedIcon* self, guint32 value);
...
void unity_protocol_scope_service_activate (UnityProtocolScopeService* self, const gchar* channel_id, GVariant** result_arr, int result_arr_length1, guint action_type, GHashTable* hints, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
...
void unity_protocol_scope_service_search (UnityProtocolScopeService* self, const gchar* channel_id, const gchar* search_string, GHashTable* hints, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
GHashTable* unity_protocol_scope_service_search_finish (UnityProtocolScopeService* self, GAsyncResult* _res_, GError** error);
void unity_protocol_scope_service_open_channel (UnityProtocolScopeService* self, guint channel_type, GHashTable* hints, GCancellable* cancellable, const char* sender, GAsyncReadyCallback _callback_, gpointer _user_data_);
gchar* unity_protocol_scope_service_open_channel_finish (UnityProtocolScopeService* self, GAsyncResult* _res_, GHashTable** out_hints, GError** error);
void unity_protocol_scope_service_close_channel (UnityProtocolScopeService* self, const gchar* channel_id, GHashTable* hints, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_protocol_scope_service_close_channel_finish (UnityProtocolScopeService* self, GAsyncResult* _res_, GError** error);
void unity_protocol_scope_service_push_results (UnityProtocolScopeService* self, const gchar* channel_id, const gchar* search_string, const gchar* source_scope_id, GVariant* result_variant, gchar** categories, int categories_length1, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
GHashTable* unity_protocol_scope_service_push_results_finish (UnityProtocolScopeService* self, GAsyncResult* _res_, GError** error);
...
void unity_protocol_preview_add_action_with_hints (UnityProtocolPreview* self, const gchar* id, const gchar* display_name, GIcon* icon, guint layout_hint, GHashTable* hints);
...
void unity_protocol_preview_set_no_details (UnityProtocolPreview* self, gboolean val);
...
void unity_protocol_preview_set_image_source_uri (UnityProtocolPreview* self, const gchar* value);
GIcon* unity_protocol_preview_get_image (UnityProtocolPreview* self);
void unity_protocol_preview_set_image (UnityProtocolPreview* self, GIcon* value);
...
void unity_protocol_music_preview_set_track_model (UnityProtocolMusicPreview* self, DeeSerializableModel* value);
...
void unity_protocol_payment_preview_set_header (UnityProtocolPaymentPreview* self, const gchar* value);
const gchar* unity_protocol_payment_preview_get_email (UnityProtocolPaymentPreview* self);
void unity_protocol_payment_preview_set_email (UnityProtocolPaymentPreview* self, const gchar* value);
const gchar* unity_protocol_payment_preview_get_payment_method (UnityProtocolPaymentPreview* self);
void unity_protocol_payment_preview_set_payment_method (UnityProtocolPaymentPreview* self, const gchar* value);
const gchar* unity_protocol_payment_preview_get_purchase_prize (UnityProtocolPaymentPreview* self);
void unity_protocol_payment_preview_set_purchase_prize (UnityProtocolPaymentPreview* self, const gchar* value);
const gchar* unity_protocol_payment_preview_get_purchase_type (UnityProtocolPaymentPreview* self);
void unity_protocol_payment_preview_set_purchase_type (UnityProtocolPaymentPreview* self, const gchar* value);
UnityProtocolPreviewPaymentType unity_protocol_payment_preview_get_preview_type (UnityProtocolPaymentPreview* self);
void unity_protocol_payment_preview_set_preview_type (UnityProtocolPaymentPreview* self, UnityProtocolPreviewPaymentType value);
...
void unity_protocol_social_preview_comment_raw_copy (const UnityProtocolSocialPreviewCommentRaw* self, UnityProtocolSocialPreviewCommentRaw* dest);
...
void unity_protocol_social_preview_add_comment (UnityProtocolSocialPreview* self, const gchar* id, const gchar* display_name, const gchar* content, const gchar* time);
UnityProtocolSocialPreviewCommentRaw* unity_protocol_social_preview_get_comments (UnityProtocolSocialPreview* self, int* result_length1);
GIcon* unity_protocol_social_preview_get_avatar (UnityProtocolSocialPreview* self);
void unity_protocol_social_preview_set_avatar (UnityProtocolSocialPreview* self, GIcon* value);
const gchar* unity_protocol_social_preview_get_content (UnityProtocolSocialPreview* self);
void unity_protocol_social_preview_set_content (UnityProtocolSocialPreview* self, const gchar* value);
const gchar* unity_protocol_social_preview_get_sender (UnityProtocolSocialPreview* self);
void unity_protocol_social_preview_set_sender (UnityProtocolSocialPreview* self, const gchar* value);
...
GParamSpec* unity_protocol_param_spec_meta_data_column_info (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags);
void unity_protocol_value_set_meta_data_column_info (GValue* value, gpointer v_object);
void unity_protocol_value_take_meta_data_column_info (GValue* value, gpointer v_object);
...
UnityProtocolMetaDataColumnInfo* unity_protocol_meta_data_column_info_new (const gchar* v, GError** error);
UnityProtocolMetaDataColumnInfo* unity_protocol_meta_data_column_info_construct (GType object_type, const gchar* v, GError** error);
gboolean unity_protocol_meta_data_column_info_equals (UnityProtocolMetaDataColumnInfo* self, UnityProtocolMetaDataColumnInfo* m);
...
GParamSpec* unity_protocol_param_spec_meta_data_schema_info (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags);
void unity_protocol_value_set_meta_data_schema_info (GValue* value, gpointer v_object);
void unity_protocol_value_take_meta_data_schema_info (GValue* value, gpointer v_object);
...
UnityProtocolMetaDataSchemaInfo* unity_protocol_meta_data_schema_info_from_string (const gchar* mdinfo_str, GError** error);
GHashTable* unity_protocol_meta_data_schema_info_as_hash_table (UnityProtocolMetaDataSchemaInfo* self);
gboolean unity_protocol_meta_data_schema_info_equals (UnityProtocolMetaDataSchemaInfo* self, UnityProtocolMetaDataSchemaInfo* s);
...
GParamSpec* unity_protocol_param_spec_category_definition (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags);
void unity_protocol_value_set_category_definition (GValue* value, gpointer v_object);
void unity_protocol_value_take_category_definition (GValue* value, gpointer v_object);
...
void unity_protocol_category_definition_set_renderer_hint (UnityProtocolCategoryDefinition* self, const gchar* value);
...
GParamSpec* unity_protocol_param_spec_filter_definition (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags);
void unity_protocol_value_set_filter_definition (GValue* value, gpointer v_object);
void unity_protocol_value_take_filter_definition (GValue* value, gpointer v_object);
...
gchar** unity_protocol_filter_definition_get_option_ids (UnityProtocolFilterDefinition* self, int* result_length1);
gchar** unity_protocol_filter_definition_get_option_names (UnityProtocolFilterDefinition* self, int* result_length1);
void unity_protocol_filter_definition_add_option (UnityProtocolFilterDefinition* self, const gchar* id, const gchar* name);
...
GParamSpec* unity_protocol_param_spec_scope_registry (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags);
void unity_protocol_value_set_scope_registry (GValue* value, gpointer v_object);
void unity_protocol_value_take_scope_registry (GValue* value, gpointer v_object);
...
void unity_protocol_scope_registry_find_scopes (const gchar* start_path, GAsyncReadyCallback _callback_, gpointer _user_data_);
UnityProtocolScopeRegistry* unity_protocol_scope_registry_find_scopes_finish (GAsyncResult* _res_, GError** error);
void unity_protocol_scope_registry_find_scopes_for_id (const gchar* scope_id, const gchar* root_path, GAsyncReadyCallback _callback_, gpointer _user_data_);
UnityProtocolScopeRegistry* unity_protocol_scope_registry_find_scopes_for_id_finish (GAsyncResult* _res_, GError** error);
...
GParamSpec* unity_protocol_scope_registry_param_spec_scope_registry_node (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags);
void unity_protocol_scope_registry_value_set_scope_registry_node (GValue* value, gpointer v_object);
void unity_protocol_scope_registry_value_take_scope_registry_node (GValue* value, gpointer v_object);
...
GParamSpec* unity_protocol_scope_registry_param_spec_scope_metadata (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags);
void unity_protocol_scope_registry_value_set_scope_metadata (GValue* value, gpointer v_object);
void unity_protocol_scope_registry_value_take_scope_metadata (GValue* value, gpointer v_object);
...
UnityProtocolCategoryDefinition** unity_protocol_scope_registry_scope_metadata_get_categories (UnityProtocolScopeRegistryScopeMetadata* self, int* result_length1);
UnityProtocolFilterDefinition** unity_protocol_scope_registry_scope_metadata_get_filters (UnityProtocolScopeRegistryScopeMetadata* self, int* result_length1);
gchar** unity_protocol_scope_registry_scope_metadata_get_subscope_ids (UnityProtocolScopeRegistryScopeMetadata* self, int* result_length1);
void unity_protocol_scope_registry_scope_metadata_load_from_key_file (UnityProtocolScopeRegistryScopeMetadata* self, GKeyFile* file, GError** error);
UnityProtocolScopeRegistryScopeMetadata* unity_protocol_scope_registry_scope_metadata_for_id (const gchar* scope_id, GError** error);
UnityProtocolScopeRegistryScopeMetadata* unity_protocol_scope_registry_scope_metadata_for_path (const gchar* path, GError** error);
...
void unity_protocol_scope_group_scope_info_copy (const UnityProtocolScopeGroupScopeInfo* self, UnityProtocolScopeGroupScopeInfo* dest);
...
GParamSpec* unity_protocol_param_spec_scope_group_config (const gchar* name, const gchar* nick, const gchar* blurb, GType object_type, GParamFlags flags);
void unity_protocol_value_set_scope_group_config (GValue* value, gpointer v_object);
void unity_protocol_value_take_scope_group_config (GValue* value, gpointer v_object);
...
UnityProtocolScopeGroupConfig* unity_protocol_scope_group_config_new (const gchar* file_name, GError** error);
UnityProtocolScopeGroupConfig* unity_protocol_scope_group_config_construct (GType object_type, const gchar* file_name, GError** error);
GType unity_protocol_preview_player_get_type (void) G_GNUC_CONST;
void unity_protocol_preview_player_play (UnityProtocolPreviewPlayer* self, const gchar* uri, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_protocol_preview_player_play_finish (UnityProtocolPreviewPlayer* self, GAsyncResult* _res_, GError** error);
void unity_protocol_preview_player_pause (UnityProtocolPreviewPlayer* self, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_protocol_preview_player_pause_finish (UnityProtocolPreviewPlayer* self, GAsyncResult* _res_, GError** error);
void unity_protocol_preview_player_pause_resume (UnityProtocolPreviewPlayer* self, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_protocol_preview_player_pause_resume_finish (UnityProtocolPreviewPlayer* self, GAsyncResult* _res_, GError** error);
void unity_protocol_preview_player_resume (UnityProtocolPreviewPlayer* self, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_protocol_preview_player_resume_finish (UnityProtocolPreviewPlayer* self, GAsyncResult* _res_, GError** error);
void unity_protocol_preview_player_stop (UnityProtocolPreviewPlayer* self, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_protocol_preview_player_stop_finish (UnityProtocolPreviewPlayer* self, GAsyncResult* _res_, GError** error);
void unity_protocol_preview_player_close (UnityProtocolPreviewPlayer* self, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_protocol_preview_player_close_finish (UnityProtocolPreviewPlayer* self, GAsyncResult* _res_, GError** error);
void unity_protocol_preview_player_video_properties (UnityProtocolPreviewPlayer* self, const gchar* uri, GAsyncReadyCallback _callback_, gpointer _user_data_);
GHashTable* unity_protocol_preview_player_video_properties_finish (UnityProtocolPreviewPlayer* self, GAsyncResult* _res_, GError** error);
UnityProtocolPreviewPlayer* unity_protocol_preview_player_new (void);
UnityProtocolPreviewPlayer* unity_protocol_preview_player_construct (GType object_type);
GType unity_protocol_scope_proxy_get_type (void) G_GNUC_CONST;
void unity_protocol_scope_proxy_activate (UnityProtocolScopeProxy* self, const gchar* channel_id, GVariant** result_arr, int result_arr_length1, UnityProtocolActionType action_type, GHashTable* hints, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_protocol_scope_proxy_activate_finish (UnityProtocolScopeProxy* self, GAsyncResult* _res_, UnityProtocolActivationReplyRaw* result, GError** error);
void unity_protocol_scope_proxy_search (UnityProtocolScopeProxy* self, const gchar* channel_id, const gchar* search_string, GHashTable* hints, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
GHashTable* unity_protocol_scope_proxy_search_finish (UnityProtocolScopeProxy* self, GAsyncResult* _res_, GError** error);
void unity_protocol_scope_proxy_open_channel (UnityProtocolScopeProxy* self, UnityProtocolChannelType channel_type, UnityProtocolChannelFlags channel_flags, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
gchar* unity_protocol_scope_proxy_open_channel_finish (UnityProtocolScopeProxy* self, GAsyncResult* _res_, DeeSerializableModel** results_model, GError** error);
void unity_protocol_scope_proxy_close_channel (UnityProtocolScopeProxy* self, const gchar* channel_id, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_protocol_scope_proxy_close_channel_finish (UnityProtocolScopeProxy* self, GAsyncResult* _res_, GError** error);
void unity_protocol_scope_proxy_set_active_sources (UnityProtocolScopeProxy* self, const gchar* channel_id, gchar** sources, int sources_length1, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_protocol_scope_proxy_set_active_sources_finish (UnityProtocolScopeProxy* self, GAsyncResult* _res_, GError** error);
void unity_protocol_scope_proxy_push_results (UnityProtocolScopeProxy* self, const gchar* channel_id, const gchar* search_string, const gchar* source_scope_id, DeeSerializableModel* model, gchar** categories, int categories_length1, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
GHashTable* unity_protocol_scope_proxy_push_results_finish (UnityProtocolScopeProxy* self, GAsyncResult* _res_, GError** error);
void unity_protocol_scope_proxy_new_for_id (const gchar* id, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
UnityProtocolScopeProxy* unity_protocol_scope_proxy_new_for_id_finish (GAsyncResult* _res_, GError** error);
void unity_protocol_scope_proxy_new_from_dbus (const gchar* dbus_name, const gchar* dbus_path, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
UnityProtocolScopeProxy* unity_protocol_scope_proxy_new_from_dbus_finish (GAsyncResult* _res_, GError** error);
void unity_protocol_scope_proxy_new_from_metadata (UnityProtocolScopeRegistryScopeMetadata* metadata, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_);
UnityProtocolScopeProxy* unity_protocol_scope_proxy_new_from_metadata_finish (GAsyncResult* _res_, GError** error);
...
void unity_protocol_scope_proxy_set_view_type (UnityProtocolScopeProxy* self, UnityProtocolViewType value);
