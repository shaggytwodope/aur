/* unity.h generated by valac 0.28.0, the Vala compiler, do not modify */
...
typedef void (*UnityScopeSearchBaseCallback) (UnityScopeSearchBase* instance, void* user_data);
typedef enum  {
...
struct _UnityScopeSearchBaseClass {
	...
	void (*run_async) (UnityScopeSearchBase* self, UnityScopeSearchBaseCallback async_callback, void* async_callback_target);
...
typedef void (*UnityAbstractPreviewCallback) (UnityResultPreviewer* previewer, UnityAbstractPreview* preview, void* user_data);
...
struct _UnityResultPreviewerClass {
	...
	void (*run_async) (UnityResultPreviewer* self, UnityAbstractPreviewCallback async_callback, void* async_callback_target);
};
...
typedef void (*UnitySimpleScopeSearchRunFunc) (UnityScopeSearchBase* search, void* user_data);
typedef void (*UnitySimpleScopeSearchRunAsyncFunc) (UnityScopeSearchBase* search, UnityScopeSearchBaseCallback cb, void* cb_target, void* user_data);
typedef UnityActivationResponse* (*UnitySimpleScopeActivateFunc) (UnityScopeResult* _result_, UnitySearchMetadata* metadata, const gchar* action_id, void* user_data);
typedef UnityAbstractPreview* (*UnitySimpleScopePreviewRunFunc) (UnityResultPreviewer* previewer, void* user_data);
typedef void (*UnitySimpleScopePreviewRunAsyncFunc) (UnityResultPreviewer* previewer, UnityAbstractPreviewCallback cb, void* cb_target, void* user_data);
...
void unity_annotated_icon_set_colorize_rgba (UnityAnnotatedIcon* self, gdouble r, gdouble g, gdouble b, gdouble a);
UnityAnnotatedIcon* unity_annotated_icon_new (GIcon* base_icon);
UnityAnnotatedIcon* unity_annotated_icon_construct (GType object_type, GIcon* base_icon);
...
void unity_annotated_icon_set_ribbon (UnityAnnotatedIcon* self, const gchar* value);
UnityCategoryType unity_annotated_icon_get_category (UnityAnnotatedIcon* self);
void unity_annotated_icon_set_category (UnityAnnotatedIcon* self, UnityCategoryType value);
UnityIconSizeHint unity_annotated_icon_get_size_hint (UnityAnnotatedIcon* self);
void unity_annotated_icon_set_size_hint (UnityAnnotatedIcon* self, UnityIconSizeHint value);
...
UnityProgressSourceProvider* unity_progress_source_provider_new (const gchar* dbus_name, const gchar* dbus_path);
UnityProgressSourceProvider* unity_progress_source_provider_construct (GType object_type, const gchar* dbus_name, const gchar* dbus_path);
...
UnityCategory* unity_category_new (const gchar* id, const gchar* name, GIcon* icon_hint, UnityCategoryRenderer renderer);
UnityCategory* unity_category_construct (GType object_type, const gchar* id, const gchar* name, GIcon* icon_hint, UnityCategoryRenderer renderer);
void unity_category_add_metadata_provider (UnityCategory* self, UnityMetadataProvider* provider);
...
void unity_category_set_content_type (UnityCategory* self, UnityCategoryContentType value);
const gchar* unity_category_get_renderer_hint (UnityCategory* self);
void unity_category_set_renderer_hint (UnityCategory* self, const gchar* value);
...
void unity_options_filter_set_show_all_button (UnityOptionsFilter* self, gboolean value);
...
void unity_preferences_manager_set_remote_content_search (UnityPreferencesManager* self, UnityPreferencesManagerRemoteContent value);
gchar** unity_preferences_manager_get_always_search (UnityPreferencesManager* self, int* result_length1);
void unity_preferences_manager_set_always_search (UnityPreferencesManager* self, gchar** value, int value_length1);
gchar** unity_preferences_manager_get_home_lens_priority (UnityPreferencesManager* self, int* result_length1);
void unity_preferences_manager_set_home_lens_priority (UnityPreferencesManager* self, gchar** value, int value_length1);
gchar** unity_preferences_manager_get_home_lens_default_view (UnityPreferencesManager* self, int* result_length1);
void unity_preferences_manager_set_home_lens_default_view (UnityPreferencesManager* self, gchar** value, int value_length1);
gchar** unity_preferences_manager_get_disabled_scopes (UnityPreferencesManager* self, int* result_length1);
void unity_preferences_manager_set_disabled_scopes (UnityPreferencesManager* self, gchar** value, int value_length1);
...
void unity_search_context_copy (const UnitySearchContext* self, UnitySearchContext* dest);
void unity_search_context_destroy (UnitySearchContext* self);
GType unity_deprecated_scope_search_get_type (void) G_GNUC_CONST;
void unity_deprecated_scope_search_set_reply_hint (UnityDeprecatedScopeSearch* self, const gchar* key, GVariant* variant);
UnityFilter* unity_deprecated_scope_search_get_filter (UnityDeprecatedScopeSearch* self, const gchar* filter_id);
gboolean unity_deprecated_scope_search_equals (UnityDeprecatedScopeSearch* self, UnityDeprecatedScopeSearch* other);
...
UnityAggregatedScopeSearch* unity_aggregated_scope_search_new (UnityAggregatorScope* owner, const gchar* channel_id, GHashTable* hints, DeeSerializableModel* results_model);
UnityAggregatedScopeSearch* unity_aggregated_scope_search_construct (GType object_type, UnityAggregatorScope* owner, const gchar* channel_id, GHashTable* hints, DeeSerializableModel* results_model);
void unity_aggregated_scope_search_search_scope (UnityAggregatedScopeSearch* self, const gchar* scope_id, const gchar* search_string, UnitySearchType search_type, GHashTable* hints, GAsyncReadyCallback _callback_, gpointer _user_data_);
GHashTable* unity_aggregated_scope_search_search_scope_finish (UnityAggregatedScopeSearch* self, GAsyncResult* _res_, GError** error);
void unity_aggregated_scope_search_push_results (UnityAggregatedScopeSearch* self, const gchar* scope_id, DeeSerializableModel* results_model, gchar** category_ids, int category_ids_length1, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_aggregated_scope_search_push_results_finish (UnityAggregatedScopeSearch* self, GAsyncResult* _res_);
void unity_aggregated_scope_search_push_filter_settings (UnityAggregatedScopeSearch* self, UnityFilterSet* filters);
...
void unity_preview_set_image_source_uri (UnityPreview* self, const gchar* value);
...
UnityPreviewAction* unity_preview_action_new_with_uri (const gchar* uri, const gchar* display_name, GIcon* icon_hint);
UnityPreviewAction* unity_preview_action_construct_with_uri (GType object_type, const gchar* uri, const gchar* display_name, GIcon* icon_hint);
...
void unity_preview_action_set_extra_text (UnityPreviewAction* self, const gchar* value);
...
UnityGenericPreview* unity_generic_preview_new (const gchar* title, const gchar* description, GIcon* image);
UnityGenericPreview* unity_generic_preview_construct (GType object_type, const gchar* title, const gchar* description, GIcon* image);
...
UnityMusicPreview* unity_music_preview_new (const gchar* title, const gchar* subtitle, GIcon* image);
UnityMusicPreview* unity_music_preview_construct (GType object_type, const gchar* title, const gchar* subtitle, GIcon* image);
...
UnityPaymentPreview* unity_payment_preview_new (const gchar* title, const gchar* subtitle, GIcon* image);
UnityPaymentPreview* unity_payment_preview_construct (GType object_type, const gchar* title, const gchar* subtitle, GIcon* image);
UnityPaymentPreview* unity_payment_preview_new_for_type (const gchar* title, const gchar* subtitle, GIcon* image, UnityPaymentPreviewType type);
UnityPaymentPreview* unity_payment_preview_construct_for_type (GType object_type, const gchar* title, const gchar* subtitle, GIcon* image, UnityPaymentPreviewType type);
UnityPaymentPreview* unity_payment_preview_new_for_application (const gchar* title, const gchar* subtitle, GIcon* image);
UnityPaymentPreview* unity_payment_preview_construct_for_application (GType object_type, const gchar* title, const gchar* subtitle, GIcon* image);
UnityPaymentPreview* unity_payment_preview_new_for_music (const gchar* title, const gchar* subtitle, GIcon* image);
UnityPaymentPreview* unity_payment_preview_construct_for_music (GType object_type, const gchar* title, const gchar* subtitle, GIcon* image);
UnityPaymentPreview* unity_payment_preview_new_for_error (const gchar* title, const gchar* subtitle, GIcon* image);
UnityPaymentPreview* unity_payment_preview_construct_for_error (GType object_type, const gchar* title, const gchar* subtitle, GIcon* image);
const gchar* unity_payment_preview_get_header (UnityPaymentPreview* self);
void unity_payment_preview_set_header (UnityPaymentPreview* self, const gchar* value);
const gchar* unity_payment_preview_get_email (UnityPaymentPreview* self);
void unity_payment_preview_set_email (UnityPaymentPreview* self, const gchar* value);
const gchar* unity_payment_preview_get_payment_method (UnityPaymentPreview* self);
void unity_payment_preview_set_payment_method (UnityPaymentPreview* self, const gchar* value);
const gchar* unity_payment_preview_get_purchase_prize (UnityPaymentPreview* self);
void unity_payment_preview_set_purchase_prize (UnityPaymentPreview* self, const gchar* value);
const gchar* unity_payment_preview_get_purchase_type (UnityPaymentPreview* self);
void unity_payment_preview_set_purchase_type (UnityPaymentPreview* self, const gchar* value);
UnityPaymentPreviewType unity_payment_preview_get_preview_type (UnityPaymentPreview* self);
void unity_payment_preview_set_preview_type (UnityPaymentPreview* self, UnityPaymentPreviewType value);
GType unity_movie_preview_get_type (void) G_GNUC_CONST;
UnityMoviePreview* unity_movie_preview_new (const gchar* title, const gchar* subtitle, const gchar* description, GIcon* image);
UnityMoviePreview* unity_movie_preview_construct (GType object_type, const gchar* title, const gchar* subtitle, const gchar* description, GIcon* image);
...
UnitySocialPreview* unity_social_preview_new (const gchar* sender, const gchar* subtitle, const gchar* content, GIcon* avatar);
UnitySocialPreview* unity_social_preview_construct (GType object_type, const gchar* sender, const gchar* subtitle, const gchar* content, GIcon* avatar);
GType unity_social_preview_comment_get_type (void) G_GNUC_CONST;
void unity_social_preview_add_comment (UnitySocialPreview* self, UnitySocialPreviewComment* comment);
GIcon* unity_social_preview_get_avatar (UnitySocialPreview* self);
void unity_social_preview_set_avatar (UnitySocialPreview* self, GIcon* value);
const gchar* unity_social_preview_get_content (UnitySocialPreview* self);
void unity_social_preview_set_content (UnitySocialPreview* self, const gchar* value);
const gchar* unity_social_preview_get_sender (UnitySocialPreview* self);
void unity_social_preview_set_sender (UnitySocialPreview* self, const gchar* value);
UnitySocialPreviewComment* unity_social_preview_comment_new (const gchar* id, const gchar* name, const gchar* text, const gchar* time);
UnitySocialPreviewComment* unity_social_preview_comment_construct (GType object_type, const gchar* id, const gchar* name, const gchar* text, const gchar* time);
...
UnityActivationResponse* unity_activation_response_new_with_search (const gchar* search_string, UnityFilterSet* filter_set, UnitySearchMetadata* search_metadata);
UnityActivationResponse* unity_activation_response_construct_with_search (GType object_type, const gchar* search_string, UnityFilterSet* filter_set, UnitySearchMetadata* search_metadata);
...
void unity_scope_result_copy (const UnityScopeResult* self, UnityScopeResult* dest);
void unity_scope_result_destroy (UnityScopeResult* self);
UnityAggregatorActivation* unity_aggregator_activation_new (const gchar* channel_id, const gchar* scope_id, guint action_type, UnityScopeResult* _result_);
UnityAggregatorActivation* unity_aggregator_activation_construct (GType object_type, const gchar* channel_id, const gchar* scope_id, guint action_type, UnityScopeResult* _result_);
const gchar* unity_aggregator_activation_get_channel_id (UnityAggregatorActivation* self);
void unity_aggregator_activation_set_channel_id (UnityAggregatorActivation* self, const gchar* value);
const gchar* unity_aggregator_activation_get_scope_id (UnityAggregatorActivation* self);
void unity_aggregator_activation_set_scope_id (UnityAggregatorActivation* self, const gchar* value);
guint unity_aggregator_activation_get_action_type (UnityAggregatorActivation* self);
void unity_aggregator_activation_set_action_type (UnityAggregatorActivation* self, guint value);
UnityScopeResult* unity_aggregator_activation_get_scope_result (UnityAggregatorActivation* self);
void unity_aggregator_activation_set_scope_result (UnityAggregatorActivation* self, UnityScopeResult* value);
...
void unity_filter_set_add (UnityFilterSet* self, UnityFilter* filter);
UnityFilter* unity_filter_set_get_filter_by_id (UnityFilterSet* self, const gchar* filter_id);
...
void unity_category_set_add (UnityCategorySet* self, UnityCategory* category);
...
void unity_schema_field_info_copy (const UnitySchemaFieldInfo* self, UnitySchemaFieldInfo* dest);
void unity_schema_field_info_destroy (UnitySchemaFieldInfo* self);
void unity_schema_add_field (UnitySchema* self, const gchar* name, const gchar* schema, UnitySchemaFieldType type);
...
UnityScopeResult* unity_scope_result_create (const gchar* uri, const gchar* icon_hint, guint category, UnityResultType result_type, const gchar* mimetype, const gchar* title, const gchar* comment, const gchar* dnd_uri, GHashTable* metadata);
...
void unity_scope_search_base_run_async (UnityScopeSearchBase* self, UnityScopeSearchBaseCallback async_callback, void* async_callback_target);
void unity_scope_search_base_set_search_context (UnityScopeSearchBase* self, UnitySearchContext* ctx);
UnityScopeSearchBase* unity_scope_search_base_construct (GType object_type);
void unity_result_set_add_result (UnityResultSet* self, UnityScopeResult* _result_);
void unity_result_set_add_result_from_variant (UnityResultSet* self, GVariant* variant);
void unity_result_set_flush (UnityResultSet* self);
UnityResultSet* unity_result_set_construct (GType object_type);
guint8* unity_abstract_preview_serialize_as (UnityAbstractPreview* self, UnitySerializationType serialization_type, int* result_length1);
...
void unity_result_previewer_run_async (UnityResultPreviewer* self, UnityAbstractPreviewCallback async_callback, void* async_callback_target);
void unity_result_previewer_set_scope_result (UnityResultPreviewer* self, UnityScopeResult* scope_result);
void unity_result_previewer_set_search_metadata (UnityResultPreviewer* self, UnitySearchMetadata* search_metadata);
...
UnityGeoCoordinate* unity_geo_coordinate_new (gdouble latitude_, gdouble longitude_);
UnityGeoCoordinate* unity_geo_coordinate_construct (GType object_type, gdouble latitude_, gdouble longitude_);
UnityGeoCoordinate* unity_geo_coordinate_new_with_altitude (gdouble latitude_, gdouble longitude_, gdouble altitude_);
UnityGeoCoordinate* unity_geo_coordinate_construct_with_altitude (GType object_type, gdouble latitude_, gdouble longitude_, gdouble altitude_);
gboolean unity_geo_coordinate_has_valid_altitude (UnityGeoCoordinate* self);
UnitySearchContext* unity_search_context_create (const gchar* search_query, UnitySearchType search_type, UnityFilterSet* filter_state, GHashTable* metadata, UnityResultSet* result_set, UnityCancellable* cancellable);
void unity_search_context_set_search_metadata (UnitySearchContext *self, UnitySearchMetadata* metadata);
UnityScopeSearchBase* unity_abstract_scope_create_search_for_query (UnityAbstractScope* self, UnitySearchContext* search_context);
UnityResultPreviewer* unity_abstract_scope_create_previewer (UnityAbstractScope* self, UnityScopeResult* _result_, UnitySearchMetadata* metadata);
...
UnityActivationResponse* unity_abstract_scope_activate (UnityAbstractScope* self, UnityScopeResult* _result_, UnitySearchMetadata* metadata, const gchar* action_id);
gchar* unity_abstract_scope_normalize_search_query (UnityAbstractScope* self, const gchar* search_query);
void unity_abstract_scope_results_invalidated (UnityAbstractScope* self, UnitySearchType search_type);
...
UnityScopeDBusConnector* unity_scope_dbus_connector_construct (GType object_type, UnityAbstractScope* scope);
void unity_scope_dbus_connector_export (UnityScopeDBusConnector* self, GError** error);
...
UnityDeprecatedScopeBase* unity_deprecated_scope_base_construct (GType object_type, const gchar* dbus_path_, const gchar* id_);
void unity_deprecated_scope_base_export (UnityDeprecatedScopeBase* self, GError** error);
...
void unity_deprecated_scope_base_set_search_in_global (UnityDeprecatedScopeBase* self, gboolean value);
gboolean unity_deprecated_scope_base_get_visible (UnityDeprecatedScopeBase* self);
void unity_deprecated_scope_base_set_visible (UnityDeprecatedScopeBase* self, gboolean value);
...
void unity_deprecated_scope_base_set_search_hint (UnityDeprecatedScopeBase* self, const gchar* value);
...
void unity_deprecated_scope_base_set_categories (UnityDeprecatedScopeBase* self, UnityCategorySet* value);
UnityFilterSet* unity_deprecated_scope_base_get_filters (UnityDeprecatedScopeBase* self);
void unity_deprecated_scope_base_set_filters (UnityDeprecatedScopeBase* self, UnityFilterSet* value);
UnitySchema* unity_deprecated_scope_base_get_schema (UnityDeprecatedScopeBase* self);
void unity_deprecated_scope_base_set_schema (UnityDeprecatedScopeBase* self, UnitySchema* value);
GType unity_deprecated_scope_get_type (void) G_GNUC_CONST;
void unity_deprecated_scope_preview_result (UnityDeprecatedScope* self, UnityScopeResult* _result_, GAsyncReadyCallback _callback_, gpointer _user_data_);
UnityPreview* unity_deprecated_scope_preview_result_finish (UnityDeprecatedScope* self, GAsyncResult* _res_);
void unity_deprecated_scope_activate_result (UnityDeprecatedScope* self, UnityScopeResult* _result_, GAsyncReadyCallback _callback_, gpointer _user_data_);
UnityActivationResponse* unity_deprecated_scope_activate_result_finish (UnityDeprecatedScope* self, GAsyncResult* _res_);
UnityDeprecatedScope* unity_deprecated_scope_new (const gchar* dbus_path_, const gchar* id_);
UnityDeprecatedScope* unity_deprecated_scope_construct (GType object_type, const gchar* dbus_path_, const gchar* id_);
void unity_deprecated_scope_queue_search_changed (UnityDeprecatedScope* self, UnitySearchType search_type);
...
gint unity_aggregator_scope_category_index_for_scope_id (UnityAggregatorScope* self, const gchar* scope_id);
UnityAggregatorScope* unity_aggregator_scope_construct (GType object_type, const gchar* dbus_path_, const gchar* id_, UnityAggregatorScopeMergeMode merge_mode, gboolean proxy_filter_hints);
void unity_aggregator_scope_add_sorter (UnityAggregatorScope* self, guint category_index, const gchar* field, UnityAggregatorScopeSortFlags flags);
void unity_aggregator_scope_add_constraint (UnityAggregatorScope* self, gint category_index, const gchar* field);
void unity_aggregator_scope_search (UnityAggregatorScope* self, UnityAggregatedScopeSearch* scope_search, GAsyncReadyCallback _callback_, gpointer _user_data_);
void unity_aggregator_scope_search_finish (UnityAggregatorScope* self, GAsyncResult* _res_);
void unity_aggregator_scope_activate (UnityAggregatorScope* self, UnityAggregatorActivation* activation, GAsyncReadyCallback _callback_, gpointer _user_data_);
UnityActivationResponse* unity_aggregator_scope_activate_finish (UnityAggregatorScope* self, GAsyncResult* _res_);
UnityAggregatorScopeMergeMode unity_aggregator_scope_get_merge_mode (UnityAggregatorScope* self);
void unity_aggregator_scope_set_merge_mode (UnityAggregatorScope* self, UnityAggregatorScopeMergeMode value);
gboolean unity_aggregator_scope_get_proxy_filter_hints (UnityAggregatorScope* self);
void unity_aggregator_scope_set_proxy_filter_hints (UnityAggregatorScope* self, gboolean value);
gboolean unity_aggregator_scope_get_automatic_flushing (UnityAggregatorScope* self);
void unity_aggregator_scope_set_automatic_flushing (UnityAggregatorScope* self, gboolean value);
GType unity_master_scope_get_type (void) G_GNUC_CONST;
UnityMasterScope* unity_master_scope_new (const gchar* dbus_path_, const gchar* id_);
UnityMasterScope* unity_master_scope_construct (GType object_type, const gchar* dbus_path_, const gchar* id_);
const gchar* unity_master_scope_get_no_content_hint (UnityMasterScope* self);
void unity_master_scope_set_no_content_hint (UnityMasterScope* self, const gchar* value);
GType unity_simple_scope_get_type (void) G_GNUC_CONST;
void unity_simple_scope_set_search_func (UnitySimpleScope* self, UnitySimpleScopeSearchRunFunc func, void* func_target, GDestroyNotify func_target_destroy_notify);
void unity_simple_scope_set_search_async_func (UnitySimpleScope* self, UnitySimpleScopeSearchRunAsyncFunc func, void* func_target, GDestroyNotify func_target_destroy_notify);
void unity_simple_scope_set_activate_func (UnitySimpleScope* self, UnitySimpleScopeActivateFunc func, void* func_target, GDestroyNotify func_target_destroy_notify);
void unity_simple_scope_set_preview_func (UnitySimpleScope* self, UnitySimpleScopePreviewRunFunc func, void* func_target, GDestroyNotify func_target_destroy_notify);
void unity_simple_scope_set_preview_async_func (UnitySimpleScope* self, UnitySimpleScopePreviewRunAsyncFunc func, void* func_target, GDestroyNotify func_target_destroy_notify);
...
void unity_simple_scope_set_filter_set (UnitySimpleScope* self, UnityFilterSet* value);
UnityCategorySet* unity_simple_scope_get_category_set (UnitySimpleScope* self);
void unity_simple_scope_set_category_set (UnitySimpleScope* self, UnityCategorySet* value);
UnitySchema* unity_simple_scope_get_schema (UnitySimpleScope* self);
void unity_simple_scope_set_schema (UnitySimpleScope* self, UnitySchema* value);
const gchar* unity_simple_scope_get_search_hint (UnitySimpleScope* self);
void unity_simple_scope_set_search_hint (UnitySimpleScope* self, const gchar* value);
const gchar* unity_simple_scope_get_group_name (UnitySimpleScope* self);
void unity_simple_scope_set_group_name (UnitySimpleScope* self, const gchar* value);
const gchar* unity_simple_scope_get_unique_name (UnitySimpleScope* self);
void unity_simple_scope_set_unique_name (UnitySimpleScope* self, const gchar* value);
...
GList* unity_scope_loader_get_scopes (UnityScopeLoader* self, const gchar* module_name, const gchar* module_type, GError** error);
void unity_scope_loader_export_scopes (UnityScopeLoader* self, GList* scopes, GError** error);
void unity_scope_loader_load_group (UnityScopeLoader* self, const gchar* group_name, GError** error);
void unity_scope_loader_load_scope (UnityScopeLoader* self, const gchar* scope_id, GError** error);
void unity_scope_loader_load_module (UnityScopeLoader* self, const gchar* module, const gchar* module_type, GError** error);
